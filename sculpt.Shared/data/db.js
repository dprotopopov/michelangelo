...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(sculpt.config.endpoints);

    var serviceConfig = $.extend(true, {}, sculpt.config.services, {
        db: {
    ...
    sculpt.db = new DevExpress.data.ODataContext(serviceConfig.db);
